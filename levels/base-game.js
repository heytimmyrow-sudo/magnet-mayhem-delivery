import { levelText } from "../localization/en.js";
...
export const baseGameLevels = [
  ...
  {
    id: "soft_spikes", ...levelText("soft_spikes"), targetTime: 34,
  ...
  {
    id: "polarity_door", ...levelText("polarity_door"), targetTime: 36,
  ...
  {
    id: "moving_bridge", ...levelText("moving_bridge"), targetTime: 40,
  ...
  {
    id: "plate_gate", ...levelText("plate_gate"), targetTime: 42,
  ...
  {
    id: "moving_charge", ...levelText("moving_charge"), targetTime: 44,
  ...
  {
    id: "throw_lane", ...levelText("throw_lane"), targetTime: 46,
  ...
  {
    id: "crusher_intro", ...levelText("crusher_intro"), targetTime: 46,
    spawn: { x: 54, y: 430 }, package: { x: 122, y: 452 }, delivery: { x: 806, y: 432, w: 92, h: 68 },
  ...
  {
    id: "electric_choice", ...levelText("electric_choice"), targetTime: 48,
  ...
  {
    id: "box_button", ...levelText("box_button"), targetTime: 50,
  ...
  {
    id: "combo_bridge", ...levelText("combo_bridge"), targetTime: 54,
  ...
  {
    id: "combo_gate", ...levelText("combo_gate"), targetTime: 56,
    spawn: { x: 54, y: 430 }, package: { x: 122, y: 452 }, delivery: { x: 806, y: 432, w: 92, h: 68 },
  ...
  {
    id: "final_sort", ...levelText("final_sort"), targetTime: 62,
